...
type MapControlsProps = {
  ...
  /** Show a button to reset the map to a default view (default: false) */
  showResetView?: boolean;
  /** Center to fly to when reset view is clicked */
  resetCenter?: [number, number];
  /** Zoom level to fly to when reset view is clicked */
  resetZoom?: number;
...
function MapControls({
  ...
  return (
    ...
    >
      ...
      {showResetView && (
        <ControlGroup>
          <ControlButton onClick={handleResetView} label="Reset to global view">
